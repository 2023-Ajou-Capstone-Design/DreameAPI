...
### 시 리스트 조회
호출 URL : http://3.130.31.88:5000/City/Si?Do=%EA%B2%BD%EA%B8%B0%EB%8F%84
결과 예시 : 
```json
{
	"items": [
...
### 군구 리스트 조회
호출 URL : http://3.130.31.88:5000/City/GunGu?Do=%EA%B2%BD%EA%B8%B0%EB%8F%84&Si=%EC%88%98%EC%9B%90%EC%8B%9C
결과 예시 : 
```json
{
	"items": [
...
### 동 리스트 조회
호출 URL : http://3.130.31.88:5000/City/Dong?Do=%EA%B2%BD%EA%B8%B0%EB%8F%84&Si=%EC%88%98%EC%9B%90%EC%8B%9C&GunGu=%EC%9E%A5%EC%95%88%EA%B5%AC
결과 예시 : 
```json
{
	"items": [
