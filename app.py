...
# #     sql = "SELECT StoreInfo.StoreID, StoreInfo.StoreType, StoreInfo.StorePointLng, StoreInfo.StorePointLat,\
# #             Tag.CateName, Tag.SubCateName, StoreDetail.StorePhoto, StoreDetail.StoreName\
# #             FROM Bookmarks\
...
# #     rows = cur.fetchall()
# #     keys = ("StoreID","StoreType","StoreName","StorePhoto", "CateName","SubCateName","StorePointLng","StorePointLat")
# #     items = [dict(zip(keys,row)) for row in rows]
# #     for item in items :
# #         item["StorePhoto"] = base64ToString(item["StorePhoto"])
# #     con.close()
